        ...
        <div class="table-responsive">            
            <table class="table table-striped table-bordered table-hover">
                ...
                if(@$_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if($pencarian != '') {
                        $sql = "SELECT * FROM tb_siswa WHERE nama_sws LIKE '%$pencarian%'";
                        $query = $sql;
                        $queryJml = $sql;
                    } else {
                    ...
                    while($data = mysqli_fetch_array($sql_poli)) { ?>
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="edit.php?id=<?=$data['id_sws'];?>" class="btn btn-warning btn-xs"><i class="glyphicon glyphicon-edit"></i></a>
                                <a href="del.php?id=<?=$data['id_sws'];?>" onclick="return confirm('Yakin akan menghapus data?')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></a>
                            </td>
                        </tr>
                    <?php
                    }
